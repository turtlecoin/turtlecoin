...
public:
  ...
  virtual void getWalletSyncData(std::vector<Crypto::Hash>&& knownBlockIds, uint64_t timestamp, std::vector<WalletTypes::WalletBlockInfo>& newBlocks, const Callback& callback) = 0;
