...
- For example on Ubuntu: `sudo apt-get install -y build-essential python-dev gcc g++ git cmake libboost-all-dev libreadline-dev libncurses-dev`
...
- Install the [GNU Readline](https://tiswww.case.edu/php/chet/readline/rltop.html) library. Run ```brew install readline; brew link --force readline```
- Install the [ncurses](https://www.gnu.org/software/ncurses/) library. Run ```brew install ncurses; brew link --force ncurses```
