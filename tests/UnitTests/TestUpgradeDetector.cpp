...
namespace
{
    ...
    void createBlocks(BlockVector &blockchain, UpgradeDetector &upgradeDetector, size_t count, uint8_t majorVersion,
    ...
    TEST_F(UpgradeDetector_voting_init, handlesAFewCompleteUpgrades)
    {
        ...
        createBlocks(blocks, currency.upgradeVotingWindow() * currency.upgradeVotingThreshold() / 100,
                     BLOCK_MAJOR_VERSION_2, BLOCK_MINOR_VERSION_1);
        ...
        createBlocks(blocks, currency.upgradeVotingWindow() * currency.upgradeVotingThreshold() / 100, BLOCK_V3,
    ...
    TEST_F(UpgradeDetector_voting, handlesVotingCompleteStartingEmptyBlockchain)
    {
        ...
        createBlocks(blocks, upgradeDetector, currency.upgradeVotingWindow(), BLOCK_MAJOR_VERSION_1,
                     BLOCK_MINOR_VERSION_0);
        createBlocks(blocks, upgradeDetector, currency.minNumberVotingBlocks(), BLOCK_MAJOR_VERSION_1,
                     BLOCK_MINOR_VERSION_1);
        ASSERT_EQ(upgradeDetector.votingCompleteHeight(), blocks.size() - 1);
    }
    ...
    TEST_F(UpgradeDetector_voting, handlesVotingCompleteStartingNonEmptyBlockchain)
    {
        ...
        createBlocks(blocks, upgradeDetector, currency.upgradeVotingWindow(), BLOCK_MAJOR_VERSION_1,
                     BLOCK_MINOR_VERSION_0);
        createBlocks(blocks, upgradeDetector, currency.minNumberVotingBlocks() - portion, BLOCK_MAJOR_VERSION_1,
                     BLOCK_MINOR_VERSION_1);
    ...
    TEST_F(UpgradeDetector_voting, handlesVotingCancelling)
    {
        ...
        createBlocks(blocks, upgradeDetector, hadrforkHeight - votingCompleteHeight - 1, BLOCK_MAJOR_VERSION_1,
                     BLOCK_MINOR_VERSION_0);
        ASSERT_EQ(upgradeDetector.votingCompleteHeight(), votingCompleteHeight);
    ...
    TEST_F(UpgradeDetector_voting, handlesVotingAndUpgradeCancelling)
    {
        ...
        createBlocks(blocks, upgradeDetector, hadrforkHeight - votingCompleteHeight, BLOCK_MAJOR_VERSION_1,
                     BLOCK_MINOR_VERSION_0);
