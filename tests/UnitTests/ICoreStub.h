...
public:
    ...
    addBlock(const CryptoNote::CachedBlock &cachedBlock, CryptoNote::RawBlock &&rawBlock) override;
    ...
    virtual void getBlocks(const std::vector<Crypto::Hash> &blockHashes, std::vector<CryptoNote::RawBlock> &blocks,
    ...
    virtual bool getBlockTemplate(CryptoNote::BlockTemplate &b, const CryptoNote::AccountPublicAddress &adr,
    ...
    virtual bool getPoolChanges(const Crypto::Hash &tailBlockId, const std::vector<Crypto::Hash> &knownTxsIds,
                                ...
                                std::vector<Crypto::Hash> &deletedTxsIds) const override;
    ...
    virtual bool queryBlocks(const std::vector<Crypto::Hash> &block_ids, uint64_t timestamp,
                             ...
                             std::vector<CryptoNote::BlockFullInfo> &entries) const override;

    virtual bool queryBlocksLite(const std::vector<Crypto::Hash> &block_ids, uint64_t timestamp,
                                 uint32_t &start_height, uint32_t &current_height, uint32_t &full_offset,
                                 std::vector<CryptoNote::BlockShortInfo> &entries) const override;
    ...
    virtual void getTransactions(const std::vector<Crypto::Hash> &txs_ids, std::vector<CryptoNote::BinaryArray> &txs,
                                 std::vector<Crypto::Hash> &missed_txs) const override;
