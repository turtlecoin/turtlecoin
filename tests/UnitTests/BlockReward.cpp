...
#define TEST_ALREADY_GENERATED_COINS(alreadyGeneratedCoins, expectedReward)              \
    ...
    {
        TEST_ALREADY_GENERATED_COINS(m_currency.moneySupply() - ((UINT64_C(2) << m_currency.emissionSpeedFactor()) + 1),
                                     2);
    ...
    protected:
        ...
        {
            m_blockTooBig = !m_currency.getBlockReward(BLOCK_MAJOR_VERSION_1, medianBlockSize, currentBlockSize,
    ...
    protected:
        ...
        virtual void SetUp() override
        {
            m_blockTooBig = !m_currency.getBlockReward(BLOCK_MAJOR_VERSION_3, testMedian, 0, alreadyGeneratedCoins, 0,
                                                       m_standardBlockReward, m_emissionChange);
        ...
        {
            m_blockTooBig = !m_currency.getBlockReward(BLOCK_MAJOR_VERSION_3, testMedian, currentBlockSize,
                                                       alreadyGeneratedCoins, 0, m_blockReward, m_emissionChange);
        }
    ...
    protected:
        virtual void SetUp() override
        {
            ...
            m_blockTooBig = !m_currency.getBlockReward(BLOCK_MAJOR_VERSION_3, testMedianV1, testBlockSizeV1, 0, 0,
        ...
        {
            m_blockTooBig = !m_currency.getBlockReward(CryptoNote::BLOCK_MAJOR_VERSION_1, testMedianV1, testBlockSizeV1,
                                                       alreadyGeneratedCoins, fee, m_blockReward, m_emissionChange);
        }

        void do_testV2(uint64_t alreadyGeneratedCoins, uint64_t fee)
        {
            m_blockTooBig = !m_currency.getBlockReward(CryptoNote::BLOCK_MAJOR_VERSION_2, testMedianV2, testBlockSizeV2,
                                                       alreadyGeneratedCoins, fee, m_blockReward, m_emissionChange);
        }
