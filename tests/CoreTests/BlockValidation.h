...
public:
            ...
            m_blockMajorVersion(blockMajorVersion)
    {
        ...
        currencyBuilder.upgradeHeightV2(
                blockMajorVersion == CryptoNote::BLOCK_MAJOR_VERSION_1 ? CryptoNote::IUpgradeDetector::UNDEF_HEIGHT
                                                                       : UINT32_C(0));
    ...
    bool
    check_block_verification_context(std::error_code bve, size_t eventIdx, const CryptoNote::BlockTemplate & /*blk*/)
    {
...
struct CheckBlockAccepted : public test_chain_unit_base
{
    ...
    bool
    check_block_accepted(CryptoNote::Core &c, size_t /*eventIdx*/, const std::vector<test_event_entry> & /*events*/)
    {
...
struct gen_block_invalid_prev_id : public CheckBlockPurged
{
    ...
    bool
    check_block_verification_context(std::error_code bve, size_t event_idx, const CryptoNote::BlockTemplate & /*blk*/);
};
