...
namespace CryptoNote
{
    ...
    {
    public:
        RpcServer(System::Dispatcher &dispatcher, std::shared_ptr<Logging::ILogger> log, Core &c, NodeServer &p2p,
    ...
    private:
        ...
        bool on_get_wallet_sync_data(const COMMAND_RPC_GET_WALLET_SYNC_DATA::request &req,
        ...
        bool
        on_get_fee_info(const COMMAND_RPC_GET_FEE_ADDRESS::request &req, COMMAND_RPC_GET_FEE_ADDRESS::response &res);
        ...
        bool
        f_on_transactions_pool_json(const F_COMMAND_RPC_GET_POOL::request &req, F_COMMAND_RPC_GET_POOL::response &res);
