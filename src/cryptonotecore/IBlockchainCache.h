...
namespace CryptoNote
{
    ...
    class IBlockchainCache
    {
        public:
            ...
            virtual bool isTransactionSpendTimeUnlocked(
                uint64_t unlockTime,
                uint32_t blockIndex
            ) const = 0;
            ...
            virtual std::vector<uint64_t> getLastTimestamps(
                size_t count,
                uint32_t blockIndex,
                UseGenesis
            ) const = 0;
            ...
            virtual std::vector<uint64_t> getLastBlocksSizes(
                size_t count,
                uint32_t blockIndex,
                UseGenesis
            ) const = 0;

            virtual std::vector<uint64_t> getLastCumulativeDifficulties(
                size_t count,
                uint32_t blockIndex,
                UseGenesis
            ) const = 0;
