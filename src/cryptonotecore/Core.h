...
namespace CryptoNote
{
                 ...
                 public ICoreInformation
    {
        public:
            ...
            virtual std::vector<RawBlock> getBlocks(
                uint32_t minIndex,
                uint32_t count
            ) const override;
            ...
            virtual std::error_code addBlock(
            ...
            virtual std::tuple<
                bool, BinaryArray
            > getPoolTransaction(const Crypto::Hash &transactionHash) const override;
        ...
        private:
            ...
            std::error_code validateSemantic(
            ...
            BlockTemplate restoreBlockTemplate(
            ...
            ); //Checks pool txs only for double spend.
