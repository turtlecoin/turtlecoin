...
namespace CryptoNote
{
    ...
    class BlockchainCache : public IBlockchainCache
    {
        public:
            ...
            bool isTransactionSpendTimeUnlocked(
                uint64_t unlockTime,
                uint32_t blockIndex
            ) const override;
            ...
            std::vector<uint64_t> getLastTimestamps(
                size_t count,
                uint32_t blockIndex,
                UseGenesis
            ) const override;
            ...
            std::vector<uint64_t> getLastBlocksSizes(
                size_t count,
                uint32_t blockIndex,
                UseGenesis
            ) const override;

            std::vector<uint64_t> getLastCumulativeDifficulties(
                size_t count,
                uint32_t blockIndex,
                UseGenesis
            ) const override;
            ...
            virtual std::vector<Crypto::Hash> getBlockHashes(
                uint32_t startIndex,
                size_t maxCount
            ) const override;
            ...
            virtual size_t getKeyOutputsCountForAmount(
                uint64_t amount,
                uint32_t blockIndex
            ) const override;
            ...
            virtual BinaryArray getRawTransaction(
                uint32_t blockIndex,
                uint32_t transactionIndex
            ) const override;
            ...
            virtual std::vector<uint32_t> getRandomOutsByAmount(
                uint64_t amount,
                size_t count,
                uint32_t blockIndex
            ) const override;
            ...
            virtual std::vector<Crypto::Hash> getBlockHashesByTimestamps(
        ...
        private:
            ...
            typedef boost::multi_index_container<
                SpentKeyImage, boost::multi_index::indexed_by<
            ...
            typedef boost::multi_index_container<
                CachedTransactionInfo, boost::multi_index::indexed_by<
                    boost::multi_index::hashed_unique<
                        boost::multi_index::tag<TransactionInBlockTag>, boost::multi_index::composite_key<
            ...
            typedef boost::multi_index_container<
                CachedBlockInfo, boost::multi_index::indexed_by<
            ...
            typedef boost::multi_index_container<
                PaymentIdTransactionHashPair, boost::multi_index::indexed_by<
            ...
            void splitKeyOutputsGlobalIndexes(
                BlockchainCache &newCache,
                uint32_t splitBlockIndex
            );
