...
struct COMMAND_RPC_GET_BLOCKS_FAST
{
    ...
    struct request
    {
        std::vector<Crypto::Hash>
            block_ids; //*first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and
                       //so on, and the last one is always genesis block */
...
inline void to_json(nlohmann::json &j, const RandomOuts &r) { j = {{"amount", r.amount}, {"outs", r.outs}}; }
