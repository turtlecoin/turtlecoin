...
// noexcept
template <class T> bool toBinaryArray(const T &object, BinaryArray &binaryArray)
{
    try
    {
...
template <> bool toBinaryArray(const BinaryArray &object, BinaryArray &binaryArray);

// throws exception if serialization failed
template <class T> BinaryArray toBinaryArray(const T &object)
{
    BinaryArray ba;
...
template <class T> T fromBinaryArray(const BinaryArray &binaryArray)
{
    T object;
...
template <class T> bool fromBinaryArray(T &object, const BinaryArray &binaryArray)
{
    try
    {
