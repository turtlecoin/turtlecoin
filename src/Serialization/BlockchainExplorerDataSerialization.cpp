...
void getVariantValue(CryptoNote::ISerializer &serializer, uint8_t tag, mpark::variant<CryptoNote::BaseInputDetails, CryptoNote::KeyInputDetails> &in)
{
