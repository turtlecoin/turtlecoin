...
bool BinaryInputStreamSerializer::beginObject(Common::StringView name) { return true; }
...
void BinaryInputStreamSerializer::checkedRead(char *buf, uint64_t size) { read(stream, buf, size); }
