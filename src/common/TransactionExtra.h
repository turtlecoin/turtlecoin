...
namespace CryptoNote
{
    ...
    typedef boost::variant<
        TransactionExtraPadding, TransactionExtraPublicKey, TransactionExtraNonce, TransactionExtraMergeMiningTag
    ...
    {
        auto it = std::find_if(
            tx_extra_fields.begin(), tx_extra_fields.end(), [](const TransactionExtraField &f)
        {
    ...
    bool addTransactionPublicKeyToExtra(
        std::vector<uint8_t> &tx_extra,
