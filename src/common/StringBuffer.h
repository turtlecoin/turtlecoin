...
namespace Common
{
    ...
    template<uint64_t MAXIMUM_SIZE_VALUE>
    class StringBuffer
    {
        public:
            typedef char Object;
    ...
    template<uint64_t MAXIMUM_SIZE> const typename StringBuffer<MAXIMUM_SIZE>::Size
