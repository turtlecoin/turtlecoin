...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 20304;
...
const uint64_t MONEY_SUPPLY                                  = UINT64_C(1800000000000000);
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(100000000000000);
...
*/
const char     GENESIS_COINBASE_TX_HEX[]                     = "010a01ff00018080e983b1de16029b2e4c0281c0b02e7c53291a94d1d0cbff8883f8024f5142ee494ffbbd0880712101482f8c10cf889c540e620f06d9a9d1d2504bb37089d796b007f59715febfbe79";
static_assert(sizeof(GENESIS_COINBASE_TX_HEX)/sizeof(*GENESIS_COINBASE_TX_HEX) != 1, "GENESIS_COINBASE_TX_HEX must not be empty.");

/* This is the unix timestamp of the first "mined" block (technically block 2, not the genesis block)
   You can get this value by doing "print_block 2" in TurtleCoind. It is used to know what timestamp
   to import from when the block height cannot be found in the node or the node is offline. */
const uint64_t GENESIS_BLOCK_TIMESTAMP                       = 1544495900;
...
const char     CRYPTONOTE_NAME[]                             = "BitcoinTiger";
...
const int      P2P_DEFAULT_PORT                              =  30001;
const int      RPC_DEFAULT_PORT                              =  30002;
...
const char     LATEST_VERSION_URL[]                          = "http://tobedecided.lol";
const std::string LICENSE_URL                                = "https://github.com/BitcoinTiger/BitcoinTiger/blob/master/LICENSE";
const static   boost::uuids::uuid CRYPTONOTE_NETWORK         =
{
    {  0x21, 0x65, 0x6f, 0x6e, 0x34, 0x6c, 0x61, 0x73, 0x79, 0x69, 0x63, 0xa4, 0xb6, 0xc1, 0x43, 0xe9  }
};
