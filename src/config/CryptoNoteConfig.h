...
const uint32_t CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW          = 24;
...
/* Premine amount */
const uint64_t GENESIS_BLOCK_REWARD                          = UINT64_C(2100000);
...
const uint64_t DEFAULT_DUST_THRESHOLD                        = UINT64_C(5);
const uint64_t DEFAULT_DUST_THRESHOLD_V2                     = UINT64_C(5);
...
const int      P2P_DEFAULT_PORT                              =  17120;
const int      RPC_DEFAULT_PORT                              =  17122;
...
{
    {  0xc5, 0x0b, 0x5a, 0x5c, 0xdf, 0x42, 0x67, 0x31, 0x66, 0xe9, 0x92, 0xa3, 0xb7, 0xb1, 0x44, 0xe8  }
};

const char* const SEED_NODES[] = {
  "178.128.175.196:17120",//dog
  "178.128.164.134:17120", //cat
