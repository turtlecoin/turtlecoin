...
namespace CryptoNote
{
    ...
    bool BinaryOutputStreamSerializer::beginArray(
        uint64_t &size,
    ...
    bool BinaryOutputStreamSerializer::operator()(
        uint8_t &value,
        Common::StringView name
    )
    {
    ...
    bool BinaryOutputStreamSerializer::binary(
        void *value,
        uint64_t size,
        Common::StringView name
    )
    ...
    void BinaryOutputStreamSerializer::checkedWrite(
        const char *buf,
        uint64_t size
    )
    {
