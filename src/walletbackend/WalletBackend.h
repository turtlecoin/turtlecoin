...
class WalletBackend
{
    public:
        ...
        /* Imports a wallet from a mnemonic seed. Returns the wallet class,
           or an error. */
        static std::tuple<
            Error, std::shared_ptr<WalletBackend>> importWalletFromSeed(
        ...
        static std::tuple<
            Error, std::shared_ptr<WalletBackend>> importWalletFromKeys(
        ...
        static std::tuple<
            Error, std::shared_ptr<WalletBackend>> importViewWallet(
            const Crypto::SecretKey privateViewKey,
        ...
        static std::tuple<
            Error, std::shared_ptr<WalletBackend>> createWallet(
            const std::string filename,
            const std::string password,
            const std::string daemonHost,
            const uint16_t daemonPort,
        ...
        static std::tuple<
            Error, std::shared_ptr<WalletBackend>> openWallet(
            const std::string filename,
            const std::string password,
            const std::string daemonHost,
            const uint16_t daemonPort,
        ...
        > getPrimaryAddressPrivateKeys() const;

        /* Get the primary address mnemonic seed, if possible */
        std::tuple<
            Error, std::string
        > getMnemonicSeed() const;
        ...
        std::vector<
            std::tuple<
                std::string, uint64_t, uint64_t>> getBalances() const;
