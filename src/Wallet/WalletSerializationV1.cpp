...
//DO NOT CHANGE IT
    ...
    void deserializeEncrypted(Object &obj, const std::string &name,
                              CryptoNote::WalletSerializerV1::CryptoContext &cryptoContext,
...
namespace CryptoNote
{
    ...
    void
    WalletSerializerV1::loadWallet(Common::IInputStream &source, const Crypto::chacha8_key &key, uint32_t version)
    {
    ...
    void WalletSerializerV1::subscribeWallets()
    {
        ...
        for (auto it = index.begin(); it != index.end(); ++it)
        {
            ...
            bool r = index.modify(it,
                                  [&subscription](WalletRecord &rec)
...
// can't do it in loadTransactions, TransfersContainer is not yet loaded
    ...
    void
    WalletSerializerV1::loadTransfers(Common::IInputStream &source, CryptoContext &cryptoContext, uint32_t version)
    {
        uint64_t count = 0;
