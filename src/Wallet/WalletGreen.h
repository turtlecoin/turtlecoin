...
namespace CryptoNote
{
    ...
    {
    public:
        WalletGreen(System::Dispatcher &dispatcher, const Currency &currency, INode &node, Logging::ILogger &logger,
        ...
        virtual void
        save(WalletSaveLevel saveLevel = WalletSaveLevel::SAVE_ALL, const std::string &extra = "") override;
        ...
        createAddressList(const std::vector<Crypto::SecretKey> &spendSecretKeys) override;
...
#pragma pack(pop)
        ...
        std::string addWallet(const Crypto::PublicKey &spendPublicKey, const Crypto::SecretKey &spendSecretKey,
                              uint64_t creationTimestamp);
