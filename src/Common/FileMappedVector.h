...
template <class T> bool FileMappedVector<T>::isOpened() const { return m_file.isOpened(); }
...
template <class T> bool FileMappedVector<T>::getAutoFlush() const { return m_autoFlush; }

template <class T> void FileMappedVector<T>::setAutoFlush(bool autoFlush) { m_autoFlush = autoFlush; }
...
template <class T> uint8_t *FileMappedVector<T>::prefixPtr() { return m_file.data(); }

template <class T> const uint8_t *FileMappedVector<T>::prefixPtr() const { return m_file.data(); }
...
template <class T> const uint64_t *FileMappedVector<T>::sizePtr() const { return capacityPtr() + 1; }

template <class T> uint64_t *FileMappedVector<T>::sizePtr() { return capacityPtr() + 1; }

template <class T> T *FileMappedVector<T>::vectorDataPtr() { return reinterpret_cast<T *>(sizePtr() + 1); }
...
template <class T> uint64_t FileMappedVector<T>::vectorDataSize() { return capacity() * valueSize; }

template <class T> uint64_t FileMappedVector<T>::nextCapacity() { return capacity() + capacity() / 2 + 1; }
