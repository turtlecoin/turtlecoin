...
static inline uint32_t div128_32(uint64_t dividend_hi, uint64_t dividend_lo, uint32_t divisor, uint64_t *quotient_hi,
...
static inline void memcpy_ident32(void *dst, const void *src, uint64_t n) { memcpy(dst, src, 4 * n); }
static inline void memcpy_ident64(void *dst, const void *src, uint64_t n) { memcpy(dst, src, 8 * n); }
