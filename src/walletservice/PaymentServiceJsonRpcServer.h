    ...
    class PaymentServiceJsonRpcServer : public CryptoNote::JsonRpcServer
    {
        ...
        private:
            ...
            typedef std::function<
                void(
                    const Common::JsonValue &jsonRpcParams,
                    Common::JsonValue &jsonResponse
                )
            > HandlerFunction;
                ...
                ) mutable
                {
                    ...
                    try
                    {
                        CryptoNote::JsonInputValueSerializer
                            inputSerializer(const_cast<Common::JsonValue &>(jsonRpcParams));
            ...
            std::error_code handleExport(
                const Export::Request &request,
                Export::Response &response
            );

            std::error_code handleReset(
            ...
            std::error_code handleGetTransactions(
            ...
            std::error_code handleGetTransaction(
                const GetTransaction::Request &request,
                GetTransaction::Response &response
            );

            std::error_code handleSendTransaction(
                SendTransaction::Request &request,
            ...
            std::error_code handleNodeFeeInfo(
