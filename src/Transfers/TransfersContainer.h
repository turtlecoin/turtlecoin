...
namespace CryptoNote
{
    ...
    {
    public:
        TransfersContainer(const CryptoNote::Currency &currency, Logging::ILogger &logger,
    ...
    private:
        ...
        typedef boost::multi_index_container<
                ...
                boost::multi_index::indexed_by<
                        boost::multi_index::hashed_unique<BOOST_MULTI_INDEX_MEMBER(TransactionInformation, Crypto::Hash,
                                                                                   transactionHash) >,
                        boost::multi_index::ordered_non_unique<BOOST_MULTI_INDEX_MEMBER(TransactionInformation,
                                                                                        uint32_t, blockHeight) >
                >
