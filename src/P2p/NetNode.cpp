...
#undef INVOKE_HANDLER
    ...
    //-----------------------------------------------------------------------------------
    bool
    NodeServer::handshake(CryptoNote::LevinProtocol &proto, P2pConnectionContext &context, bool just_take_peerlist)
    {
        ...
        BOOST_FOREACH(PeerlistEntry &be, local_peerlist)
                    {
                        ...
                        {
                            logger(ERROR) << "FOUND FUTURE peerlist for entry " << be.adr << " last_seen: "
